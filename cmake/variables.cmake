...
# only relevant for the developer(s) of CodeTask Targets necessary to build the
# project must be provided unconditionally, so consumers can trivially build and
# package the project
if(PROJECT_IS_TOP_LEVEL)
  option(CodeTask_DEVELOPER_MODE "Enable developer mode" OFF)
endif()
...
if(NOT PROJECT_IS_TOP_LEVEL)
  option(CodeTask_INCLUDES_WITH_SYSTEM
         "Use SYSTEM modifier for CodeTask's includes, disabling warnings" ON)
  mark_as_advanced(CodeTask_INCLUDES_WITH_SYSTEM)
  if(CodeTask_INCLUDES_WITH_SYSTEM)
